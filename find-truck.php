...
<head>
  <title>Find Your Truck:KIA</title>
...
<body>
  ...
  <div class="backgr_image2 cintainer">
    <div class="form1">
      <pre class="find"> <h1><b>Find your Truck </b></h1></pre>
      <form onsubmit="return Validate()" action="truckhandler.php" method="post">
