  ...
  <nav class="navbar navbar-expand-lg bg-dark navbar-dark" id="nav1">
    ...
    <div class="container-fluid" >
      <div class="row">
        <div class="container-fluid">
          <h2 >
            Two of Kia's official Dealers has renovated their
            showrooms according to the new guidelines
          </h2>
        </div>
        <div class="col-md-12">
          <div class="news_item">
            <img class="img-fluid" src="images/61e485d6c26c01642366422.png"
              alt="Opening of KIA new service center at Sheraton">
            <br>
            <br>
            <p>o El GENDY at El Mahla El Kobra <br />

              o NAHDET MASR ( El QADY) at 10th of Ramdan</p>
          </div>
        </div>
      </div>
    </div>
