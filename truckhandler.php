...
$year=$_POST['year'];
$color=$_POST['color'];
$sql = " SELECT img_path,information FROM kiatrucks WHERE model = '$model ' && year = '$year' && color='$color'";
...
<body>
  ...
  <div class="container resdiv">

<?php
    while ($row = $result -> fetch_row()) {
        ?>
        <div class="card border-dark mb-3 justify-content-center box" style="max-width: 940px; height: 25rem;">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="<?php echo $row[0]?>" class="img-fluid rounded-start card-img-top" "alt="...">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h1 class="card-title"><?php echo $model?></h1>
            <p class="card-text" style="font-family:Sofia; font-size:18px;">
