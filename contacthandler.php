...
$myemail ='kiacustomer23@gmail.com';
...
if (mail($to, $email_subject, $email_body, $headers ,$headers)) {
?>
...
<body>
  ...
  <h1 style="text-align:center; margin-top: 150px;" ><?php echo "Thank you for contacting us.</br> We will be in touch with you very soon.";?> </h1>
</br></br></br></br></br>
  <footer>
    <div class="row">
      <div class="col">
