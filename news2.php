  ...
  <nav class="navbar navbar-expand-lg bg-dark navbar-dark" id="nav1">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="container-fluid">
          <h2 >
            Kattamya and Roxy Branch Renovation
          </h2>
        </div>
        <div class="col-md-12">
          <div class="news_item">
            <img class="img-fluid" src="images/61e4832e0ee0f1642365742.png" alt="Kattamya and Roxy Branch Renovation">
            <br>
            <br>
            <p>o KIA has changed El Kattamya branch from 2s Facility in to 3s Facility (Sales, Service and Spare parts )
              according to the new Guideline .
              <br>
              o KIA has changed Roxy branch according to the new Guideline</p>
          </div>
        </div>
      </div>
    </div>
